...
\begin{quote}
        ...
        \begin{quote}
            ...
            \hspace{-5cm}
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/flatsin10_05abget_zeit}
                          \caption{Sinus 10 kHz alpha 0,5 moduliertes Signal}
		                  \label{fig:flatsin10_05zeit}
                    \end{figure}
                \end{minipage}
                
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/flatsin20_05abget_zeit}
                       \caption{Sinus 20 kHz alpha 0,5 moduliertes Signal}
		              \label{fig:flatsin20_05zeit}
                    \end{figure}
                \end{minipage}
            ...
            \TODO{Thommy: hier drüber und drunter, das sind exakt die selben bilder. da müsste doch nen unterschied in
            der abtastfrequenz zu sehen sein oder?}
            ...
            \hspace{-5cm}
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/flatsin10_05}
                          \caption{Sinus 10 kHz alpha 0,5 Rekonstruktion}
		                  \label{fig:flatsin10_05}
                    \end{figure}
                \end{minipage}
                
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/flatsin20_05}
                       \caption{Sinus 20 kHz alpha 0,5 Rekonstruktion}
		              \label{fig:flatsin20_05}
                    \end{figure}
                \end{minipage}
            ...
            Signal, das mit 20 kHz Flat-Top abgetastet wurde wie erwartet mit weniger Überschwingen rekonstruiert werden
            kann. Eine erhöte Abtastfrequenz zahlt sich also bei der genauigkeit der Übertragung aus.
    ...
    \begin{quote}
        ...
        \begin{quote}
            ...
            \hspace{-5cm}
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/shapesin10_05abget_zeit}
                          \caption{Sinus 10 kHz alpha 0,5 moduliertes Signal}
		                  \label{fig:shapesin10_05zeit}
                    \end{figure}
                \end{minipage}
                
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/shapesin20_05abget_zeit}
                       \caption{Siunus 20 kHz alpha 0,5 moduliertes Signal}
		              \label{fig:shapesin20_05zeit}
                    \end{figure}
                \end{minipage}
            ...
            \TODO{Thommy: auch hier sind die Bilder exakt gleich. Ich hab die vier Bilder in der Matlab-Datei schon mal
            rausgesucht, kannst du sie noch abspeichern?}
            ...
            \hspace{-5cm}
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/shapesin10_05}
                          \caption{Sinus 10 kHz alpha 0,5 Rekonstruktion}
		                  \label{fig:shapesin10_05}
                    \end{figure}
                \end{minipage}
                
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.55, trim = 16mm 70mm 16mm 85mm, clip]{Bilder/shapesin20_05}
                       \caption{Sinus 20 kHz alpha 0,5 Rekonstruktion}
		              \label{fig:shapesin20_05}
                    \end{figure}
                \end{minipage}
        ...
        größer gewählt werden kann bzw. der Nebenzipfel im Frequenzbereich komplett verschwindet.
	...
	%\end{figure}
            ...
            \ \\
             ...
             \\
             ersetzt durch:\\}
             Dass die beiden Rekonstruierten signale sich so sehr ähneln liegt daran, dass wir bei der hohen
             Abtastfrequenz die Nebenpeaks im Frequenzspektrum sehr gut herausfiltern konnten. Trotzdem fällt deutlich
             auf, dass das mit höerem $\alpha$ abgetastete Signal weniger verrauscht ist. Der am Frequenzspekrtum der
             rekonstruierten Signale abgelesene Signal/Rausch-Abstand ist etwa um den Faktor 2 größer.\\
    ...
    \subsection{Vergleich Shape-Top und Flat-Top Sampling}
      \begin{quote}
             ...
             \TODO{Wär hier nicht nen Sinus aussagekräftiger?\\
                   is nicht so wichtig wenns zu viel wird}
            ...
            \hspace{-4cm}
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.7, trim = 35mm 95mm 35mm 95mm, clip]{Bilder/shapeskizze}
                          \caption{Shape-Top-Sampling Rechteck}
		                  \label{fig:shaperec}
                    \end{figure}
                \end{minipage}
                ...
                \begin{minipage}{0.6\textwidth}
                    \begin{figure}[H]
                        \includegraphics[scale=0.7, trim = 35mm 95mm 35mm 95mm, clip]{Bilder/flatskizze}
            ...
            Da bei der Signalverbreiterung die Amplituden im Spektrum von der Frequenz abhängen (Vorfaktor: $si(\omega
             ...
             \TODO{hast du ne idee? sonst raus: \\
             \\
             , was zu einer Verzerrung führt. (gibt keine Verzerrung) ja stimmt, kann ich auch nicht wirklich erkennen, sollte aber
             eigentlich so sein,\\
      ...
      \begin{center}
            ...
            \TODO{Die rekonstruierten Bilder sind wenig aussagekräftig oder? und wir gehen auch garnicht darauf ein.
            raus?}
